...
describe("Given I am connected as an Employee", function () {
  describe("When there are no iconEye in the page", function () {
    test("Then it should run without throwing any error", function () {
...
describe("Given I am a user connected as employee", () => {
  ...
  describe("When I navigate to bills page", () => {
    test("fetches bills from mock API GET", async () => {
      ...
      //Test that table body contains the bills
    ...
    describe("When an error occurs on API", () => {
      ...
      test("fetches bills from an API and fails with 404 message error", async () => {
        //Mock list store method and navigate to bills page
        ...
        //Test that message container is displayed with the given error
      ...
      test("fetches messages from an API and fails with 500 message error", async () => {
        ...
        //Test that message given error is displayed
      ...
      test("fetches messages from an API but get corrupted data", async () => {
        ...
        //Check that date is displayed without formatting
